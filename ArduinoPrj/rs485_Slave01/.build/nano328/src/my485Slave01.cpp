#include <Arduino.h>
#include "my485Slave01.h"
void fWrite(const byte what);
int  fAvailable ();
int  fRead ();
void setup();
void loop();
#line 1 "src/my485Slave01.ino"
/*
...
void loop() {
    ...
    if (rcvLen) {
        ...
        if (fDEBUG) {
            ...
            Serial.print("\n\r");Serial.print(devName);Serial.print(" - DEBUG Comando ricevuto : ");printHex(&DEBUG_TxRxMsg[1], DEBUG_TxRxLen, " - [STX ...data... CRC ETX]\r\n"); // contiene LEN STX ...data... ETX
        }

        if (destADDR != myADDR) {
            Serial.print("\n\r      Address not point to me: ");Serial.println(destADDR);
