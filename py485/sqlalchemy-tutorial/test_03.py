...
# def createDB(dbFile):
def createDB(dbCLASS, dbFile, Base=None):
    ...
    # engine = create_engine(dbFile, isolation_level='AUTOCOMMIT')
...
if __name__ == '__main__':
    ...
    engine = createDB(dbFile='sqlite:///test_03.db', dbCLASS=DeviceTable.Device, Base=DeviceTable.Base)
    sys.exit()
